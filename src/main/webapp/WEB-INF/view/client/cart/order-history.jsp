                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <c:forEach var="order" items="${orders}">
                            <!-- Chỉ hiển thị chi tiết sản phẩm, không hiển thị thông tin tổng đơn hàng -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group quantity mt-4" style="width: 100px;">
                                            <input type="text" class="form-control form-control-sm text-center border-0" value="${orderDetail.quantity}" readonly>
                                        </div>
                                    </td>
                                    <td>
                                        <p class="mb-0 mt-4">
